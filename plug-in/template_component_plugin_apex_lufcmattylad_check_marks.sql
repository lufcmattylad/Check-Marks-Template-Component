...
--   Application:     46056
--   Name:            Check Marks
--   Date and Time:   14:33 Wednesday December 27, 2023
--   Exported By:     MATT@GIZMA.COM
--   Flashback:       0
--   Export Type:     Component Export
--   Manifest
--     PLUGIN: 41687822144525754223
--   Manifest End
--   Version:         23.2.1
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(41687822144525754223)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(41710612691974892777)
,p_plugin_id=>wwv_flow_imp.id(41687822144525754223)
,p_title=>'Icon'
,p_display_sequence=>1
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41705208466273833428)
,p_plugin_id=>wwv_flow_imp.id(41687822144525754223)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41713114959769152786)
,p_plugin_id=>wwv_flow_imp.id(41687822144525754223)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(41710612691974892777)
,p_examples=>'fa-check u-success-text u-bold'
,p_help_text=>'Icon to show if Truthy'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41713155839555155479)
,p_plugin_id=>wwv_flow_imp.id(41687822144525754223)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41759373620055361954)
,p_plugin_id=>wwv_flow_imp.id(41687822144525754223)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41763023408548366804)
,p_plugin_attribute_id=>wwv_flow_imp.id(41759373620055361954)
,p_display_sequence=>10
,p_display_value=>'Truthy'
,p_return_value=>'TRUTHY'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41762956778846365885)
,p_plugin_attribute_id=>wwv_flow_imp.id(41759373620055361954)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41762025455673363927)
,p_plugin_attribute_id=>wwv_flow_imp.id(41759373620055361954)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42385681144291071952)
,p_plugin_attribute_id=>wwv_flow_imp.id(41759373620055361954)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41789155431200263055)
,p_plugin_id=>wwv_flow_imp.id(41687822144525754223)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41788151236437507315)
,p_plugin_attribute_id=>wwv_flow_imp.id(41789155431200263055)
,p_display_sequence=>10
,p_display_value=>'Truthy'
,p_return_value=>'TRUTHY'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41788152419307507864)
,p_plugin_attribute_id=>wwv_flow_imp.id(41789155431200263055)
,p_display_sequence=>20
,p_display_value=>'Falsey'
,p_return_value=>'FALSEY'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41789161858809265153)
,p_plugin_attribute_id=>wwv_flow_imp.id(41789155431200263055)
,p_display_sequence=>30
,p_display_value=>'Null'
,p_return_value=>'NULL'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(42383825052389836764)
,p_plugin_attribute_id=>wwv_flow_imp.id(41789155431200263055)
,p_display_sequence=>40
,p_display_value=>'Other'
,p_return_value=>'OTHER'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41796774375836602877)
,p_plugin_id=>wwv_flow_imp.id(41687822144525754223)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41802067972945653403)
,p_plugin_id=>wwv_flow_imp.id(41687822144525754223)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(42383740285910826245)
,p_plugin_id=>wwv_flow_imp.id(41687822144525754223)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(43743265732023548869)
,p_plugin_id=>wwv_flow_imp.id(41687822144525754223)
,p_attribute_scope=>'COMPONENT'
